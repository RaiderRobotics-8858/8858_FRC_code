    ...
    if (IS_LIMELIGHT_ENABLED) {
      ...
      limelight.getSettings()
          ...
          .withCameraOffset(new Pose3d(
              Inches.of(11.375).in(Meters),
              Inches.of(9.983).in(Meters),
              Inches.of(5).in(Meters),
              new Rotation3d(0, Degrees.of(27).in(Radians), Degrees.of(0).in(Radians))))
